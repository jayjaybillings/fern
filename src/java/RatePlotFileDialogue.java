// -----------------------------------------------------------------------------------------------------------
//  Class to RatePlotFileDialogue creates file dialog window for saving
//  postscript file associated with rates plot.  Variables:
...
class RatePlotFileDialogue extends Frame {
    ...
    public RatePlotFileDialogue(int X, int Y, int width, int height,
        Color fg, Color bg, String title, String text) {
            ...
            public void actionPerformed(ActionEvent ae){
                ...
                if ( RatePlotFileDialogue.this.hT.getText().length() > 0 ) {
                    ...
                    makeTheWarning(100,100,200,100,Color.black,
                        ...
                        true, RatePlotFileDialogue.this);
