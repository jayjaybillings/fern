// ---------------------------------------------------------------------------------------------------------------
//  Class ShowIsotopeFlux to lay out contour plotting frame for ElementMaker
//  by creating an instance of ContourFrameFlux
// ---------------------------------------------------------------------------------------------------------------
...
public class ShowIsotopeFlux {

    static Color isoBC = Color.black;     //MyColors.gray235; // Background color

    // ContourFrameFlux instance declared static in order to allow
    ...
    public ShowIsotopeFlux(String title, String contourLegend, boolean isLog, double lower, double upper,
        double[][][] twa) {

         cd = new ContourFrameFlux(contourLegend, isLog, lower, upper, twa);
        ...
        s.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
              ContourFileDialogueFlux fd =
                  new ContourFileDialogueFlux (100,130,400,110,Color.black,
