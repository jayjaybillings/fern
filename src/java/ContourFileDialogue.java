...
class ContourFileDialogue extends Frame {
   ...
   public ContourFileDialogue(int X, int Y, int width, int height, Color fg,
      ...
      saveButton.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent ae){
            ...
            // works by declaring ContourFrame instance cd and
            // ContourPad instance gp to be static and then
            // invoking the static method makePs from ContourFrame
            // to in turn invoke gp.PSfile(file).  (Note the use
            // of the "ContourFileDialogue.this" construction to
            // invoke the "this" reference for the outer class
            // ContourFileDialogue from this anonymous inner class.)
            ...
            if ( ContourFileDialogue.this.hT.getText().length() > 0 ) {
                ContourFrame.makePS(ContourFileDialogue.this.hT.getText());
                hide();
                dispose();
            } else {
